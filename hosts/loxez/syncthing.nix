...

{
  ...
  services.syncthing = {
    ...
    guiAddress = inputs.dotfiles-secrets.loxez.syncthing.gui_address;
    ...
    settings = {
      gui.user = inputs.dotfiles-secrets.loxez.syncthing.gui_user;
      ...
      folders = inputs.dotfiles-secrets.loxez.syncthing.folders;
    };
  };
}
