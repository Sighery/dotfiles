  ...
  home-manager.users.sighery = { config, ... }: {
    ...
    programs.autorandr = {
      ...
      profiles = {
        "work-office" = {
          fingerprint = {
            "eDP-1" = "";
            "HDMI-1" = "";
          };
          config = {
            "eDP-1" = {
              enable = true;
...
#
  ...
  users.users.sighery = {
    isNormalUser = true;
    createHome = true;
    extraGroups = [ "wheel" "audio" "video" "adbusers" "backlighters" ];
  };

  users.groups.backlighters = {};
  ...
  environment.systemPackages = with pkgs; [
    ...
    networkmanager networkmanagerapplet wpa_supplicant_gui
    ddrescue
    gimp
    smartmontools
    vlc
