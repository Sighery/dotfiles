  ...
  xsession.windowManager.i3 = with lib; {
    ...
    in {
      ...
      keybindings = {
        ...
        "XF86AudioRaiseVolume" = "exec --no-startup-id ${volumebin} set-volume @DEFAULT_AUDIO_SINK@ ${volumestep}%+";
        "XF86AudioLowerVolume" = "exec --no-startup-id ${volumebin} set-volume @DEFAULT_AUDIO_SINK@ ${volumestep}%-";
