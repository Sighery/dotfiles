  ...
  xsession.windowManager.i3 = with lib; {
    ...
    config =
      let
        ...
        #audionotif = "${audio-notification}/bin/audio-notification";
        statuscmd = "i3status";
      ...
      in
      {
        ...
        keybindings = {
          ...
          "XF86AudioRaiseVolume" =
            "exec --no-startup-id ${volumebin} set-volume @DEFAULT_AUDIO_SINK@ ${volumestep}%+";
          "XF86AudioLowerVolume" =
            "exec --no-startup-id ${volumebin} set-volume @DEFAULT_AUDIO_SINK@ ${volumestep}%-";
          "Shift+XF86AudioRaiseVolume" =
            "exec --no-startup-id ${volumebin} set-volume @DEFAULT_AUDIO_SINK@ 5%+";
          "Shift+XF86AudioLowerVolume" =
            "exec --no-startup-id ${volumebin} set-volume @DEFAULT_AUDIO_SINK@ 5%-";
          #"XF86AudioRaiseVolume" = "exec --no-startup-id pactl set-sink-volume @DEFAULT_SINK@ +5%";
          #"XF86AudioLowerVolume" = "exec --no-startup-id pactl set-sink-volume @DEFAULT_SINK@ -5%";
          #"XF86AudioMute" = "exec --no-startup-id pactl set-sink-mute @DEFAULT_SINK@ toggle";
          "XF86AudioPlay" = ''exec --no-startup-id "${pkgs.playerctl}/bin/playerctl --player=spotify,%any play-pause"'';
          "XF86AudioPause" = ''exec --no-startup-id "${pkgs.playerctl}/bin/playerctl --player=spotify,%any pause-pause"'';
          "XF86AudioNext" = ''exec --no-startup-id "${pkgs.playerctl}/bin/playerctl --player=spotify,%any next"'';
          "XF86AudioPrev" = ''exec --no-startup-id "${pkgs.playerctl}/bin/playerctl --player=spotify,%any previous"'';
